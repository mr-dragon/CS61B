...
public class CheckLabConfig {
    public static void checkConfig(boolean isWindows) {
        ...
        System.out.println("Validating your "
                + repoVariableName
    ...
    public static void checkVariableNotNull(String value, String name) {
        if (value == null) {
            System.out.println("ERROR! Environment variable "
                    + name
                    + " is not set.");
    ...
    public static void checkIsValidRepo(String value, String name,
        ...
        // System.out.println("ERROR! Your " + name + " environment variable is
        // incorrect.");
        // System.out.println("The folder name in the end should match this pattern: " +
        // expected);
        // System.exit(1);
        // }
